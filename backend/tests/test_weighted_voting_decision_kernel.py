...
def valid_context(*, daily_trade_count: int = 0, open_position: bool = False, account_observed_at: datetime | None = None, effective_settings=None, mode: str = "test_fixture"):
    payload = evaluate_payload()
    snapshot = build_weighted_voting_market_snapshot(payload)
    positions = (
    ...
    return WeightedVotingRuntimeContextBuilder(
        ...
        global_risk_port=WeightedVotingStaticGlobalRiskPort(global_available_risk=1000.0, global_max_shares=100000, gate_response=None),
