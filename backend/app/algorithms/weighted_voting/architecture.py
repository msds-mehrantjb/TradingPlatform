...
WEIGHTED_VOTING_SHARED_READ_ONLY_PORTS: Final[tuple[WeightedVotingReadOnlyPort, ...]] = (
    ...
    WeightedVotingReadOnlyPort(
        port_id="broker_account_observation",
        provider="shared_broker_account",
        access="read_only_account_positions_orders_fills_observations",
    ),
    WeightedVotingReadOnlyPort(
        port_id="clock",
...
WEIGHTED_VOTING_PIPELINE_BOUNDARIES: Final[tuple[WeightedVotingPipelineBoundary, ...]] = (
    ...
    WeightedVotingPipelineBoundary(
        ...
        fail_closed_rule="missing_account_or_inventory_capacity_rejects_new_entry",
    ),
    WeightedVotingPipelineBoundary(
    ...
    WeightedVotingPipelineBoundary(
        ...
        required_inputs=("accepted_weighted_voting_order_proposal", "idempotency_key"),
        fail_closed_rule="paper_submission_disabled_until_rollout_gates_pass",
    ),
    WeightedVotingPipelineBoundary(
        stage_id="order_fill_reconciliation",
        owner=WEIGHTED_VOTING_ALGORITHM_ID,
        authoritative_module="backend.app.algorithms.weighted_voting.broker_reconciliation",
        mutable_state_scope="weighted_voting.fills",
        required_inputs=("broker_observation", "weighted_voting_client_order_id"),
        fail_closed_rule="unattributed_or_unreconciled_broker_activity_pauses_new_entries",
    ),
    WeightedVotingPipelineBoundary(
...
def weighted_voting_architecture_contract() -> WeightedVotingArchitectureContract:
    return WeightedVotingArchitectureContract(
        ...
        broker_account_role="shared_external_resource_not_algorithm_inventory",
