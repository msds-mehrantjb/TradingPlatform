...
# Every catalogue entry is registered here, shadow included: a shadow strategy has to
# actually run to produce the evidence its promotion gate demands. Lifecycle, not this
# tuple, decides whether a strategy's vote carries weight.
