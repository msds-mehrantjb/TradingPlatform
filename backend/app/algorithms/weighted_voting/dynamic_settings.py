...
def default_weighted_settings(*, timestamp: datetime | None = None, baseline_config: WeightedVotingConfig | None = None) -> WeightedDefaultSettings:
    ...
    return WeightedDefaultSettings(
        ...
        paper_execution_mode=baseline.paper_execution_mode,
        local_paper_initial_capital=baseline.local_paper_initial_capital,
        local_paper_buy_slippage_per_share=baseline.entry_slippage_per_share,
        local_paper_sell_slippage_per_share=baseline.exit_slippage_per_share,
        local_paper_commission_per_share=baseline.fee_per_share,
        local_paper_regulatory_fee_per_share=baseline.regulatory_fee_per_share,
        local_paper_spread_impact_per_share=baseline.spread_impact_per_share,
        local_paper_spread_impact_percent=baseline.transaction_cost_buffer_percent,
        local_paper_allow_shorting=baseline.local_paper_allow_shorting,
        local_paper_partial_fill_mode=baseline.local_paper_partial_fill_mode,
...
def resolve_effective_settings(
    *,
    ...
    configuration_hash = _configuration_hash(
        ...
        limits,
        {
            **resolved,
            ...
            "paperExecutionMode": defaults.paper_execution_mode,
            "localPaperInitialCapital": defaults.local_paper_initial_capital,
            "localPaperExecutionCosts": {
                "buySlippagePerShare": defaults.local_paper_buy_slippage_per_share,
                "sellSlippagePerShare": defaults.local_paper_sell_slippage_per_share,
                "commissionPerShare": defaults.local_paper_commission_per_share,
                "regulatoryFeePerShare": defaults.local_paper_regulatory_fee_per_share,
                "spreadImpactPerShare": defaults.local_paper_spread_impact_per_share,
                "spreadImpactPercent": defaults.local_paper_spread_impact_percent,
            },
            "localPaperAllowShorting": defaults.local_paper_allow_shorting,
            "localPaperPartialFillMode": defaults.local_paper_partial_fill_mode,
    ...
    return WeightedEffectiveSettings(
        ...
        paper_execution_mode=defaults.paper_execution_mode,
        local_paper_initial_capital=defaults.local_paper_initial_capital,
        local_paper_buy_slippage_per_share=defaults.local_paper_buy_slippage_per_share,
        local_paper_sell_slippage_per_share=defaults.local_paper_sell_slippage_per_share,
        local_paper_commission_per_share=defaults.local_paper_commission_per_share,
        local_paper_regulatory_fee_per_share=defaults.local_paper_regulatory_fee_per_share,
        local_paper_spread_impact_per_share=defaults.local_paper_spread_impact_per_share,
        local_paper_spread_impact_percent=defaults.local_paper_spread_impact_percent,
        local_paper_allow_shorting=defaults.local_paper_allow_shorting,
        local_paper_partial_fill_mode=defaults.local_paper_partial_fill_mode,
...
def resolve_dynamic_settings_for_condition(
    *,
    ...
    configuration_hash = _configuration_hash(
        ...
        hard_limits,
        {
            **resolved,
            ...
            "paperExecutionMode": default_settings.paper_execution_mode,
            "localPaperInitialCapital": default_settings.local_paper_initial_capital,
            "localPaperExecutionCosts": {
                "buySlippagePerShare": default_settings.local_paper_buy_slippage_per_share,
                "sellSlippagePerShare": default_settings.local_paper_sell_slippage_per_share,
                "commissionPerShare": default_settings.local_paper_commission_per_share,
                "regulatoryFeePerShare": default_settings.local_paper_regulatory_fee_per_share,
                "spreadImpactPerShare": default_settings.local_paper_spread_impact_per_share,
                "spreadImpactPercent": default_settings.local_paper_spread_impact_percent,
            },
            "localPaperAllowShorting": default_settings.local_paper_allow_shorting,
            "localPaperPartialFillMode": default_settings.local_paper_partial_fill_mode,
            "baselineConfigurationHash": baseline.configuration_hash,
        },
        configuration_version,
    )
    return WeightedEffectiveSettings(
        ...
        family_exposure_caps=family_exposure_caps,
        paper_execution_mode=default_settings.paper_execution_mode,
        local_paper_initial_capital=default_settings.local_paper_initial_capital,
        local_paper_buy_slippage_per_share=default_settings.local_paper_buy_slippage_per_share,
        local_paper_sell_slippage_per_share=default_settings.local_paper_sell_slippage_per_share,
        local_paper_commission_per_share=default_settings.local_paper_commission_per_share,
        local_paper_regulatory_fee_per_share=default_settings.local_paper_regulatory_fee_per_share,
        local_paper_spread_impact_per_share=default_settings.local_paper_spread_impact_per_share,
        local_paper_spread_impact_percent=default_settings.local_paper_spread_impact_percent,
        local_paper_allow_shorting=default_settings.local_paper_allow_shorting,
        local_paper_partial_fill_mode=default_settings.local_paper_partial_fill_mode,
