...
def execute_regime_pipeline(payload: dict[str, Any]) -> dict[str, Any]:
    ...
    stateful = process_regime_bar(
        ...
        inventory_snapshot=payload.get("__regime_inventory_snapshot") or {},
        account_snapshot=payload.get("__regime_account_snapshot") or {},
    )
    ...
    return {
        ...
        "algorithmVersion": stateful["statefulCoreVersion"],
        ...
        "dataTimestamp": stateful.get("dataTimestamp"),
        "featureTimestamp": stateful.get("featureTimestamp"),
        "dataManifestHash": stateful["dataManifestHash"],
        "marketDataValidation": stateful.get("marketDataValidation"),
