...
REGIME_TREND_STRENGTH_AXES = ("strong", "weak", "neutral", "unknown")
...
REGIME_DATA_QUALITY_AXES = ("valid", "degraded", "invalid", "insufficient_warmup", "unknown")
