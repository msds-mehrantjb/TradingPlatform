...
def regime_backend_inventory() -> dict[str, Any]:
    return {
        ...
        "productionRuntimeCompositionRoot": "backend.app.algorithms.regime.runtime_factory.build_regime_paper_runtime",
