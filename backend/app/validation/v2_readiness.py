...
COMPLETION_CONDITIONS: tuple[ConditionSpec, ...] = (
    ...
    ConditionSpec("candidate_success_ml", "Meta-Model V2 predicts candidate success rather than replacing direction.", ("backend/app/algorithms/meta_strategy/labeling/candidate_meta_labeling.py", "backend/app/algorithms/meta_strategy/inference/safe_inference.py", "backend/tests/test_safe_ml_inference_modes.py"), ("candidate_success_probability", "cannot_create_trade_from_hold", "test_ml_cannot_flip_side")),
    ConditionSpec("oos_upstream_predictions", "Upstream ML predictions are out of sample.", ("backend/app/algorithms/meta_strategy/forecast/oos_features.py", "backend/tests/test_forecast_oos_features.py"), ("trainingWindowEnd", "cannot_predict_rows_from_its_own_fitting_period")),
    ConditionSpec("purged_walk_forward", "Training uses purged chronological walk-forward validation.", ("backend/app/algorithms/meta_strategy/training/training_core.py", "backend/tests/test_meta_strategy_nested_training.py"), ("purged", "embargo", "chronological")),
    ConditionSpec("oof_calibration", "Probability calibration uses out-of-fold predictions.", ("backend/app/algorithms/meta_strategy/training/training_core.py", "backend/tests/test_meta_probability_calibration.py"), ("out_of_fold", "rejects_in_sample")),
    ConditionSpec("economic_promotion", "Model promotion uses economic and risk metrics, not accuracy alone.", ("backend/app/algorithms/meta_strategy/training/training_core.py", "backend/tests/test_meta_strategy_economic_promotion.py"), ("netExpectancyAfterCosts", "drawdown", "accuracy")),
