...
def _score_strategies(regime: LayerResult, session: LayerResult, event: LayerResult) -> list[dict[str, Any]]:
    ...
    catalog = [
        ...
        },
        {
            ...
            "tags": ["high-volatility", "volatility-expansion", "mean-reversion", "vwap-reversion"],
        ...
        },
        {
            ...
            "tags": ["trend-day", "event-rules", "trend-follow", "volatility-expansion", "mean-reversion"],
            "blocks": ["cash-filter", "liquidity-stress"],
        },
        {
        ...
        },
        {
            ...
            "tags": ["trend-follow", "trend-day", "strong-uptrend", "strong-downtrend", "volatility-expansion"],
            "blocks": ["chop", "balanced", "volatility-contraction", "cash-filter"],
        },
        {
            "name": "Volume Confirmation",
            "tags": ["liquidity-watch", "volatility-expansion", "trend-day", "orb"],
            "blocks": ["low-volume", "liquidity-stress"],
        },
        {
            "name": "ATR Volatility Regime",
            "tags": ["high-volatility", "low-volatility", "volatility-expansion", "volatility-contraction"],
            "blocks": ["liquidity-stress", "cash-filter"],
        },
        {
