...
$log = Join-Path $root "wca-runtime.out.log"
$err = Join-Path $root "wca-runtime.err.log"
$pidFile = Join-Path $root ".tmp\wca-runtime.pid"
...
$startInfo.Arguments = "-m backend.app.algorithms.wca.runtime_main --owner-id wca-runtime-app --poll-seconds 1"
